...
TODO: {
    local $TODO = "these need to be dealt with after investigating GH issue 15";
    {
        my $mm = $new_mm->(
    ...
    }
    {
        ...
        my $res = eval { $mm->metafile_target };
        ok $res, q|we know how to deal with oddly formated meta resource keys defined in Makefile.PL|;
    }
}
